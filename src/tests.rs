...
#[test]
fn launch_own_token_18_decimals() {
    let mut app: CustomApp = mock_app(vec![
        (
            Addr::unchecked("launcher"),
            [
                coin(1_000_000_000_000_000, "usk"),
                coin(1_000_000_000_000_000_000_000_000_000, "snedown"),
            ]
            .to_vec(),
        ),
        (
    ...
    assert!(!token_response.is_managed);
    assert_eq!(token_response.symbol, "SNED");
    assert_eq!(token_response.decimals, 18);
    assert_eq!(
        token_response.denom_admin,
        Some(Addr::unchecked(
            "kujira10d07y265gmmuvt4z0w9aw880jnsr700jt23ame"
    ...
    app.execute_contract(
        ...
        keiko_addr.clone(),
        &&ExecuteMsg::PilotStart { idx: launch.idx },
        &coins(1_000_000_000_000_000_000_000_000, "snedown"),
    )
    .unwrap();
    ...
    app.send_tokens(
        Addr::unchecked("launcher"),
        keiko_addr.clone(),
        &[coin(100_000_000_000_000_000_000_000, "snedown")],
    )
    .unwrap();
